...
const MedicineCard = ({
  ...
  const filteredCurrentSymptoms = currentSymptoms?.map((symptom) => {
    const match = filteredSymptoms.find((s) =>
    ...
    <>
      ...
      >
        ...
        <CardContent
          ...
          onClick={isAdmin ? handleClickOpen : undefined}
        >
      ...
      <Dialog open={open} onClose={handleClose} fullWidth maxWidth="md">
        ...
        <DialogContent>
          <Suspense fallback={<CircularProgress />}>
            ...
            {(isAdmin ? currentSymptoms : filteredCurrentSymptoms)?.length >
              ...
              <>
                ...
                <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1 }}>
                  {(isAdmin ? currentSymptoms : filteredCurrentSymptoms).map(
                    (currentSymptom) => {
                      return (
                        <Chip
                          size="small"
